...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class MediaTracksMessage {
    private Long textureId;
    ...
    public void setTracks(String setterArg) {
    ...
    HashMap toMap() {
      HashMap<String, Object> toMapResult = new HashMap<String, Object>();
      toMapResult.put("textureId", textureId);
      toMapResult.put("tracks", tracks);
      return toMapResult;
    }

    static MediaTracksMessage fromMap(HashMap map) {
      MediaTracksMessage fromMapResult = new MediaTracksMessage();
      fromMapResult.textureId = (map.get("textureId") instanceof Integer) ? (Integer) map.get("textureId") : (Long) map.get("textureId");
      fromMapResult.tracks = (map.get("tracks") instanceof String) ? (String) map.get("tracks") : (String) map.get("tracks");

      fromMapResult.rendererIndex = (int) map.get("rendererId");
      fromMapResult.groupIndex = (int) map.get("groupId");
      fromMapResult.trackIndex = (int) map.get("trackId");
      return fromMapResult;
    }
  }
  /** Generated class from Pigeon that represents data sent in messages. */
  ...
  public interface VideoPlayerApi {
    ...
    MediaTracksMessage mediaTracks(TextureMessage arg);
    void setMediaTrack(MediaTracksMessage arg);
    ...
    public static void setup(BinaryMessenger binaryMessenger, VideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
                new BasicMessageChannel<Object>(
                        binaryMessenger,
                        "dev.flutter.pigeon.VideoPlayerApi.mediaTracks",
                        new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler(
                  new BasicMessageChannel.MessageHandler<Object>() {
                    public void onMessage(Object message, BasicMessageChannel.Reply<Object> reply) {
                      ...
                      HashMap<String, HashMap> wrapped = new HashMap<String, HashMap>();
                      try {
                        MediaTracksMessage output = api.mediaTracks(input);
                        wrapped.put("result", output.toMap());
                      } catch (Exception exception) {
                        wrapped.put("error", wrapError(exception));
                      }
      ...
      {
        BasicMessageChannel<Object> channel = new BasicMessageChannel<Object>(binaryMessenger, "dev.flutter.pigeon.VideoPlayerApi.setMediaTrack", new StandardMessageCodec());
        if (api != null) {
          channel.setMessageHandler(
                  new BasicMessageChannel.MessageHandler<Object>() {
                    public void onMessage(Object message, BasicMessageChannel.Reply<Object> reply) {
                      MediaTracksMessage input = MediaTracksMessage.fromMap((HashMap) message);
                      HashMap<String, HashMap> wrapped = new HashMap<String, HashMap>();
                      try {
                        api.setMediaTrack(input);
                        wrapped.put("result", null);
                      } catch (Exception exception) {
                        wrapped.put("error", wrapError(exception));
                      }
