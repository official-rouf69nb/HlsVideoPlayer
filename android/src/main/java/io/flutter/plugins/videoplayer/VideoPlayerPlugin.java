...
public class VideoPlayerPlugin implements FlutterPlugin, VideoPlayerApi {
  ...
  @Override
  public Messages.MediaTracksMessage mediaTracks(TextureMessage arg) {
    VideoPlayer player = videoPlayers.get(arg.getTextureId());
    Messages.MediaTracksMessage result = new Messages.MediaTracksMessage();
    result.setTracks(player.getMediaTracks());
    player.sendBufferingUpdate();
    return result;
  }

  public void setMediaTrack(Messages.MediaTracksMessage arg) {
    VideoPlayer player = videoPlayers.get(arg.getTextureId());
    player.setMediaTrack(arg.getRendererIndex(),arg.getGroupIndex(),arg.getTrackIndex());
  }
