...
class MediaTracksMessage {
  ...
  Map<dynamic, dynamic> _toMap() {
    final Map<dynamic, dynamic> pigeonMap = <dynamic, dynamic>{};
    pigeonMap['textureId'] = textureId;
    pigeonMap['tracks'] = tracks;
    pigeonMap['rendererId'] = rendererId;
  ...
  // ignore: unused_element
  static MediaTracksMessage _fromMap(Map<dynamic, dynamic> pigeonMap) {
    final MediaTracksMessage result = MediaTracksMessage();
    result.textureId = pigeonMap['textureId'];
    result.tracks = pigeonMap['tracks'];
    result.rendererId = pigeonMap['rendererId'];
    result.groupId = pigeonMap['groupId'];
    result.trackId = pigeonMap['trackId'];
    return result;
  }
}
...
class VideoPlayerApi {
  ...
  Future<MediaTracksMessage> mediaTracks(TextureMessage arg) async {
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel = BasicMessageChannel<dynamic>(
        'dev.flutter.pigeon.VideoPlayerApi.mediaTracks', StandardMessageCodec());
    ...
    if (replyMap == null) {
      ...
      return MediaTracksMessage._fromMap(replyMap['result']);
    }
  }

  Future<void> setMediaTrack(MediaTracksMessage arg) async {
    final Map<dynamic, dynamic> requestMap = arg._toMap();
    const BasicMessageChannel<dynamic> channel = BasicMessageChannel<dynamic>(
        'dev.flutter.pigeon.VideoPlayerApi.setMediaTrack', StandardMessageCodec());
