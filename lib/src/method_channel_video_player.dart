...
class MethodChannelVideoPlayer extends VideoPlayerPlatform {
  ...
  @override
  Future<String> getMediaTracks(int textureId) async{
    MediaTracksMessage response = await _api.mediaTracks (TextureMessage()..textureId = textureId);
    return response.tracks;
  }

  @override
  Future<void> setMediaTrack(int textureId, MediaTrack mediaTrack)async {
    return _api.setMediaTrack(MediaTracksMessage()
      ..textureId = textureId
      ..rendererId = mediaTrack.rendererIndex
      ..groupId = mediaTrack.groupIndex
      ..trackId = mediaTrack.trackIndex
    );
  }
