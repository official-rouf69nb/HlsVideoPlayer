...
import 'package:video_player/src/media_track.dart';
...
abstract class VideoPlayerPlatform {
  ...
  /// Sets the video position to a [Duration] from the start.
  Future<void> setMediaTrack(int textureId,MediaTrack mediaTrack) {
    throw UnimplementedError('setMediaTrack() has not been implemented.');
  }

  /// Gets the video position as [Duration] from the start.
  Future<String> getMediaTracks(int textureId) {
    throw UnimplementedError('getMediaTracks() has not been implemented.');
  }
